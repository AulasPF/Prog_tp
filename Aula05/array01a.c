...
int main(){
  ...
  /* Acrescente o código necessário para alterar os valores guardados no array, de modo a que 
   * que, quando o programa correr e chegar à instrução a instrução printf() em baixo, 
   * a sequência impressa passe a ser
   * 0 1 2 2 4
